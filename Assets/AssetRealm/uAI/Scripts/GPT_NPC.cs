...
namespace UAI{
    ...
    */
    public class GPT_NPC : MonoBehaviour
    {
        ...
        [TextArea(3, 10)]
        public string SystemInitPrompt = "You are a [mood] NPC in a game. You are talking to a player and you have to help him. You allways answer in " + GPTClient.language; 
        ...
        {   
            ...
            GPTClient.Instance.SendRequestWithHistory(conversation.chatMessages); 
