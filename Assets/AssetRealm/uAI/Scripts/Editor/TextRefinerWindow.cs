...
namespace UAI
{
    ...
    {
        #region Constants
        private string SYSTEM_INIT_PROMPT = "You are a true master of words. You can check the spelling of any text and correct it. You can also improve the text by adding more details or making it sound more interesting. You can also change the tone of the text to make it sound more professional or more casual. You can also change the format of the text to make it sound more like a poem or a story. You can also change the style of the text to make it sound more like a song or a speech. You can also change the language of the text to make it sound more like a different language or a dialect. You answer only with the text you have improved. You do not add any other text. You do not add any other information. You do not add any other comments. You do not add any other explanations. You do not add any other details. You do not add any other examples. You do not add any other references. You do not add any other sources. You do not add any other links. You do not add any other quotes. You do not add any other citations. You do not add any other notes. You allways answer in " + GPTClient.language;
        ...
        private TextField _instructionsField;
        ...
        private string _input = "Hi, what are you doing here?";
        private string _instructions = "Make it sound like a pirate saying it.";
        ...
        [SerializeField]
        private TextRefinerObject _textRefinerObject = new TextRefinerObject();
        #endregion

        #region Menu Item
        [MenuItem("Tools/uAI Creator/Text Refiner", false, 102)]
        public static void Init()
        {
            TextRefinerWindow window = (TextRefinerWindow)GetWindow(typeof(TextRefinerWindow), false, "Text Refiner");
        ...
        private void CreateGUI()
        {
            ...
            InitializeFromSerializedObject();
        ...
        private void CreateMainPanel()
        {
            ...
            var header = new Label("Text Refiner");
            ...
            var description = new Label("Improve your text with AI assistance. Paste your text and provide instructions on how you want it refined.");
            ...
            inputContainer = new Box();
            inputContainer.style.flexGrow = 2;
            ...
            var inputLabel = new Label("Input Text");
            ...
            var inputDescription = new Label("Paste the content that you want to improve.");
            inputDescription.tooltip = "Paste the content that you want to improve.";
            ...
            instructionsContainer = new Box();
            instructionsContainer.style.flexGrow = 1;
            instructionsContainer.style.marginLeft = 10;
            instructionsContainer.style.paddingTop = 10;
            instructionsContainer.style.paddingBottom = 10;
            instructionsContainer.style.paddingLeft = 10;
            instructionsContainer.style.paddingRight = 10;
            contentContainer.Add(instructionsContainer);
            
            var instructionsLabel = new Label("Instructions");
            instructionsLabel.style.fontSize = 14;
            instructionsLabel.tooltip = "Describe how you want the text to be improved (style, tone, format, etc.)";
            instructionsLabel.style.unityFontStyleAndWeight = FontStyle.Bold;
            instructionsLabel.style.marginBottom = 5;
            instructionsLabel.style.whiteSpace = WhiteSpace.Normal;
            instructionsContainer.Add(instructionsLabel);
            
            var instructionsDescription = new Label("Describe how you want the text to be improved (style, tone, format, etc.)");
            instructionsDescription.style.fontSize = 12;
            instructionsDescription.style.marginBottom = 8;
            instructionsDescription.style.whiteSpace = WhiteSpace.Normal;
            instructionsContainer.Add(instructionsDescription);
            elementsToHideOnDock.Add(instructionsDescription);
            
            _instructionsField = new TextField();
            _instructionsField.multiline = true;
            _instructionsField.value = _instructions;
            _instructionsField.style.height = 200;
            _instructionsField.style.whiteSpace = WhiteSpace.Normal;
            _instructionsField.style.unityTextAlign = TextAnchor.UpperLeft;
            _instructionsField.Q("unity-text-input").style.alignSelf = Align.Auto;
            instructionsContainer.Add(_instructionsField);
            
            
            var examplesTitle = new Label("Example instructions:");
            examplesTitle.style.fontSize = 12;
            examplesTitle.style.unityFontStyleAndWeight = FontStyle.Bold;
            examplesTitle.style.marginTop = 10;
            examplesTitle.style.whiteSpace = WhiteSpace.Normal;
            instructionsContainer.Add(examplesTitle);
            ...
            foreach (var example in examples)
            {
                ...
                instructionsContainer.Add(exampleLabel);
            ...
            _refineButton = new Button();
            _refineButton.text = "Improve the Text";
            _refineButton.AddToClassList("primary-button");
            buttonContainer.Add(_refineButton);
            
            
            _refineButton.style.height = 40;
            _refineButton.style.width = 250;
            _refineButton.style.backgroundColor = new Color(0.35f, 0.65f, 0.9f);
            _refineButton.style.color = Color.white;
            _refineButton.style.fontSize = 14;
            _refineButton.style.unityFontStyleAndWeight = FontStyle.Bold;
            _refineButton.style.borderTopWidth = 0;
            _refineButton.style.borderBottomWidth = 0;
            _refineButton.style.borderLeftWidth = 0;
            _refineButton.style.borderRightWidth = 0;
            
            
            _refineButton.RegisterCallback<MouseEnterEvent>(evt => {
                _refineButton.style.backgroundColor = new Color(0.45f, 0.75f, 1f);
            });
            
            _refineButton.RegisterCallback<MouseLeaveEvent>(evt => {
                _refineButton.style.backgroundColor = new Color(0.35f, 0.65f, 0.9f);
            });
        }
        ...
        private void CreateResponseSection()
        {
            ...
            _progressLabel = new Label("Improving text...");
            ...
            var responseTitle = new Label("Improved Text");
        ...
        private void SetupEventHandlers()
        {
            ...
            if (_instructionsField != null)
                _instructionsField.RegisterValueChangedCallback(evt => {
                    _instructions = evt.newValue;
            ...
            if (_refineButton != null)
                _refineButton.clicked += () => SendRequestToGPT(BuildPrompt());
        }
        #endregion

        #region Helper Methods
        private void InitializeFromSerializedObject()
        {
            _input = _textRefinerObject.input;
            _instructions = _textRefinerObject.instructions;
        }
        
        private void SaveToSerializedObject()
        {
            _textRefinerObject.input = _input;
            _textRefinerObject.instructions = _instructions;
            
            
            _textRefinerObject.prevtextinput = _input;
            _textRefinerObject.prevtextinstructions = _instructions;
        ...
        {
            return $"{_instructions}. The text: \"{_input}\".";
        }
        ...
        private void dockingStateChanged()
        {
            ...
            if (lastDockedState == true)
            {
                ...
                _mainContent.style.flexGrow = 1;
                _instructionsField.style.height = 60;
                _inputField.style.height = 60;
                
                inputContainer.style.width = new Length(50, LengthUnit.Percent);
                instructionsContainer.style.width = new Length(50, LengthUnit.Percent);   
            }
            else
            {
