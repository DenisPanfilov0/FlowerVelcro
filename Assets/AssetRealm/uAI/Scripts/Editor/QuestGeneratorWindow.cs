...
{ 
    ...
    {
        #region Constants
        private string SYSTEM_INIT_PROMPT = "You are a creative writer and game designer, who can generate unique quests for your game. You answer only with the quest and it's detailed description etc., but nothing else. You do not include comments. You allways answer in " + GPTClient.language;
        ...
        private TextField _gameWorldField;
        ...
        private string _instructions = "Come up with a unique quest for my game.";
        ...
        #region Menu Item
        [MenuItem("Tools/uAI Creator/Quest Generator", false, 105)]
        public static void Init()
        {
            QuestGeneratorWindow window = (QuestGeneratorWindow)GetWindow(typeof(QuestGeneratorWindow), false, "Quest Generator");
        ...
        private void CreateMainPanel()
        {
            ...
            var header = new Label("Quest Generator");
            ...
            var description = new Label("Generate unique and interesting quests for your game based on your game world description.");
            ...
            worldContainer = new Box();
            worldContainer.style.flexGrow = 1;
            worldContainer.style.marginRight = 10;
            worldContainer.style.paddingTop = 10;
            worldContainer.style.paddingBottom = 10;
            worldContainer.style.paddingLeft = 10;
            worldContainer.style.paddingRight = 10;
            contentContainer.Add(worldContainer);
            
            var worldLabel = new Label("World Description");
            worldLabel.tooltip = "Describe the game world in which the quest will take place.";
            worldLabel.style.fontSize = 14;
            worldLabel.style.unityFontStyleAndWeight = FontStyle.Bold;
            worldLabel.style.marginBottom = 5;
            worldLabel.style.whiteSpace = WhiteSpace.Normal;
            worldContainer.Add(worldLabel);
            
            var worldDescription = new Label("Describe your game world with details about its setting, inhabitants, magic systems, technology, etc.");
            ...
            worldContainer.Add(worldDescription);
            elementsToHideOnDock.Add(worldDescription);
            
            _gameWorldField = new TextField();
            _gameWorldField.multiline = true;
            _gameWorldField.value = _gameWorldDescription;
            _gameWorldField.style.height = 200;
            _gameWorldField.style.whiteSpace = WhiteSpace.Normal;
            _gameWorldField.style.unityTextAlign = TextAnchor.UpperLeft;
            _gameWorldField.Q("unity-text-input").style.alignSelf = Align.Auto;
            worldContainer.Add(_gameWorldField);
            ...
            var instructionsLabel = new Label("Quest Instructions");
            instructionsLabel.tooltip = "Provide specific instructions for the quest generation.";
            ...
            var instructionsDescription = new Label("Specify any details about the quest you want to generate (quest type, difficulty, target player level, etc.)");
            ...
            var examples = new[] {
                "Generate a side quest for a small village",
                "Create a main storyline quest with multiple objectives"
            };
            ...
            _generateButton.text = "Generate Quest";
            _generateButton.AddToClassList("primary-button");
            buttonContainer.Add(_generateButton);
            ...
            _generateButton.style.borderTopWidth = 0;
            _generateButton.style.borderBottomWidth = 0;
            _generateButton.style.borderLeftWidth = 0;
            _generateButton.style.borderRightWidth = 0;
        ...
        private void CreateResponseSection()
        {
            ...
            _progressLabel = new Label("Generating quest...");
            ...
            var responseTitle = new Label("Generated Quest");
        ...
        private void SetupEventHandlers()
        {
            ...
            if (_gameWorldField != null)
                _gameWorldField.RegisterValueChangedCallback(evt => _gameWorldDescription = evt.newValue);
                
            
            if (_instructionsField != null)
                _instructionsField.RegisterValueChangedCallback(evt => _instructions = evt.newValue);
                
            
            if (_generateButton != null)
                _generateButton.clicked += () => SendRequestToGPT(BuildPrompt());
        }
        #endregion
        ...
        {
            return $"{_gameWorldDescription} - {_instructions} - Generate the Quest:";
        }
        ...
        private void dockingStateChanged()
        {
            ...
            if (lastDockedState == true)
            {
                ...
                _gameWorldField.style.height = 60;
                
                worldContainer.style.width = new Length(50, LengthUnit.Percent);
