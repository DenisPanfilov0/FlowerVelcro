...
namespace UAI
{
    public class DeepSeekClient : AbstractAIClient
    {
        ...
        {
            this.endpointUrl = "https://api.deepseek.com/v1/chat/completions";
        ...
        private void ProcessLastToken()
        {
            ...
            // Look for a [DONE] marker which indicates the stream is complete
            ...
            if (foundDone)
            {
                // Ensure we've processed everything properly
