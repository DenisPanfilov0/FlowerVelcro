...
namespace Code
{
    public class GamePauseWindow : MonoBehaviour
    {
        ...
        [Inject]
        public void Construct(AudioManager audioManager, IGameStateService gameStateService, 
            IGameStateMachine gameStateMachine, AdvertisingService advertisingService)
        {
        ...
        private void SetupButtonListeners()
        {
            ...
            _homeButton.onClick.AddListener(HomeEnter);
        }
        ...
        {
            _audioManager.PlaySoundEffect(AudioClipTypeId.ButtonClick);
            _gameStateService.GamePause(true);
            gameObject.SetActive(true);
        }

        private void Hide()
        {
            _gameStateService.GamePause(false);
            _audioManager.PlaySoundEffect(AudioClipTypeId.ButtonClick);
        ...
        private void OnDestroy()
        {
            ...
            _homeButton.onClick.RemoveListener(HomeEnter);
        }
    }
}